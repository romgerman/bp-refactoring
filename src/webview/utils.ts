...
/** Subscribe to events */
export function useEventCommandResult<T extends EventCommand<any, any>>(command: T['command'], callback: (data: T['data']) => void) {
...
export function useEventCommandResultOnce<T extends EventCommand<any, any>>(command: T['command'], callback: (data: T['data']) => void): void {
...
export function sendEventCommandAndWaitResult<T extends EventCommand<any, any>>(command: T, callback: (data: any) => void) {
...
export async function waitForEventAsync<T extends EventCommand<any, any>>(command: T['command'], predicate?: (data: T['data']) => boolean): Promise<void> {
